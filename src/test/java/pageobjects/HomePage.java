...
public class HomePage extends BaseClass {
    ...
    private static final String BASIC_URL = "https://https://www.rsk.co";
    private static final By BUTTON_CONTACT = By.xpath("//a[contains(@href,'#contact')]");
    private static final By DIV_SOCIAL_MEDIA = By.className("s-mh s-repeatable");
    ...
    /**
     * Method used to validate that Home Page is loaded successfully
     *
     * @return boolean value
     */
    public boolean isPageLoaded() {
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(DIV_SOCIAL_MEDIA));
    ...
    /**
     * Method used to search a building with parameters
     * @param Location
     * @param Custom
     * @param Price
     * @return
     */
    public boolean searchOnPageWithParameters(String Location, String Custom,
                                              String Price) {
        try {
